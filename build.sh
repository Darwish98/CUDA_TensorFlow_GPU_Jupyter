...
NOTEBOOKS_PATH=$1
nvidia-docker build --tag tstoyanov/tf-openailab-gpu ./
nvidia-docker run -d --name jupyter -v $NOTEBOOKS_PATH:/notebooks -e NB_UID=1000 -e NB_GID=1000 -e VNC_SERVER_PASSWORD=password -p 8888:8888 -p 6006:6006 -p 5900:5900  tstoyanov/tf-openailab-gpu 
